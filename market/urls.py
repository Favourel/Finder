...
urlpatterns = [
    ...
    path("high_low_price_products/", market_view.high_low_price_products, name="high_low_price_products"),
    path("recent_products/", market_view.recent_products, name="recent_products"),
    ...
    path("product/<uuid:pk>/update/", market_view.UpdateProductView.as_view(), name="product-update"),
