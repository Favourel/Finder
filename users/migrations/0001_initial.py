    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_notification', models.ManyToManyField(blank=True, related_name='post_notify', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notification_type', models.IntegerField(choices=[(1, 'Order'), (2, 'follow'), (3, 'Post Notification')])),
                ('date_posted', models.DateTimeField(default=datetime.datetime.now)),
                ('is_seen', models.BooleanField(default=False)),
                ('orders', models.ManyToManyField(blank=True, to='market.checkout')),
